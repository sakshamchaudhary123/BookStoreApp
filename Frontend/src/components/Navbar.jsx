...
function Navbar() {
  ...
  // Synchronize the checkbox state with the theme on component mount
  useEffect(() => {
    ...
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? "sticky-navbar shadow-md bg-slate-400 duration-300 ease-in-out transition-all"
            : ""
        } `}
      >
        <div className="navbar p-1 md:p-2">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className=" cursor-pointer border-[2px] rounded-md flex items-center gap-2">
                <input
                  type="text"
                  className="grow outline-1 px-2 py-1 rounded-l-sm dark:placeholder:text-slate-900  dark:text-black"
                  placeholder="Search"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {authUser ? (
              ...
              <div>
                <a
                  className="px-3 py-2 rounded-md cursor-pointer hover:bg-slate-800 duration-300 bg-black text-white "
                  onClick={() =>
